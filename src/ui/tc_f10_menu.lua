...
local function buildCaptureStatusText()
  ...
  local lines = {
    ...
    "",
    "State-only: no ownership change executed."
  }
...
local function createMenuStructure()
  ...
  addCommand("Show Capture Ready Zones", F10Menu.menu.status, showCaptureReadyZones)
  addCommand("Show Pressure Contested Zones", F10Menu.menu.status, showPressureContestedZones)
